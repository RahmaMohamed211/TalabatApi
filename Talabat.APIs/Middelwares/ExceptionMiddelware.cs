...
namespace Talabat.APIs.Middelwares
{
    public class ExceptionMiddelware
    {
        ...
        public async Task InvokeAsync(HttpContext context)
        {
            ...
            {
                logger.LogError(ex, ex.Message); //console app
                ...
                var response = env.IsDevelopment() ?
                                new ApiExecptionResponse((int)HttpStatusCode.InternalServerError, ex.Message, ex.StackTrace.ToString())
                                  :
                                   new ApiExecptionResponse((int)HttpStatusCode.InternalServerError,ex.Message);
